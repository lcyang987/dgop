...
// ACCEPT_WITHDRAW_APPLY
export const ACCEPT_WITHDRAW_APPLY_TABLE_GET_API = 'ACCEPT_WITHDRAW_APPLY_TABLE_GET_API';
export const ACCEPT_WITHDRAW_APPLY_TABLE_APPLY_API = 'ACCEPT_WITHDRAW_APPLY_TABLE_APPLY_API';
// COLLECT_WITHDRAW_APPLY
export const COLLECT_WITHDRAW_APPLY_TABLE_GET_API = 'COLLECT_WITHDRAW_APPLY_TABLE_GET_API';
export const COLLECT_WITHDRAW_APPLY_TABLE_APPLY_API = 'COLLECT_WITHDRAW_APPLY_TABLE_APPLY_API';
// HANDLE_WITHDRAW
export const HANDLE_WITHDRAW_TABLE_GET_API = 'HANDLE_WITHDRAW_TABLE_GET_API';
export const HANDLE_WITHDRAW_TABLE_HANDLE_API = 'HANDLE_WITHDRAW_TABLE_HANDLE_API';
export const HANDLE_WITHDRAW_TABLE_CANCEL_API = 'HANDLE_WITHDRAW_TABLE_CANCEL_API';
export const HANDLE_WITHDRAW_TABLE_APPLY_API = 'HANDLE_WITHDRAW_TABLE_APPLY_API';
export const HANDLE_WITHDRAW_TABLE_DETAIL_GET_API = 'HANDLE_WITHDRAW_TABLE_DETAIL_GET_API';
// JOBDEMAND_MANAGER
export const JOBDEMAND_MANAGER_TABLE_GET_API = 'JOBDEMAND_MANAGER_TABLE_GET_API';
export const JOBDEMAND_MANAGER_DEMANDDETAIL_TABLE_GET_API = 'JOBDEMAND_MANAGER_DEMANDDETAIL_TABLE_GET_API';
export const JOBDEMAND_MANAGER_TASKCLAIM_TABLE_GET_API = 'JOBDEMAND_MANAGER_TASKCLAIM_TABLE_GET_API';
export const JOBDEMAND_MANAGER_JOBREWARD_TABLE_GET_API = 'JOBDEMAND_MANAGER_JOBREWARD_TABLE_GET_API';
export const JOBDEMAND_MANAGER_JOBREWARD_TABLE_FROZEN_API = 'JOBDEMAND_MANAGER_JOBREWARD_TABLE_FROZEN_API';
export const JOBDEMAND_MANAGER_JOBREWARD_TABLE_UNFROZEN_API = 'JOBDEMAND_MANAGER_JOBREWARD_TABLE_UNFROZEN_API';
export const JOBDEMAND_MANAGER_DEPOSITDETAIL_TABLE_GET_API = 'JOBDEMAND_MANAGER_DEPOSITDETAIL_TABLE_GET_API';
export const JOBDEMAND_MANAGER_DEPOSITREFUNDFORM_SUBMIT_REQUESTTYPE = 'DEPOSIT_MANAGER_DEPOSITREFUNDFORM_SUBMIT_REQUESTTYPE';
// REVENUE
export const REVENUE_TABLE_GET_API = 'REVENUE_TABLE_GET_API';
// ORDER
export const ORDER_TABLE_GET_API = 'ORDER_TABLE_GET_API';
// MEMBER
export const MEMBER_MANAGER_TABLE_GET_API = 'MEMBER_MANAGER_TABLE_GET_API';
export const MEMBER_MANAGER_AUDITINFO_GET_API = 'MEMBER_MANAGER_AUDITINFO_GET_API';
export const MEMBER_MANAGER_RECOMMENDINFO_GET_API = 'MEMBER_MANAGER_RECOMMENDINFO_GET_API';
export const MEMBER_MANAGER_ADDRESSTABLE_GET_API = 'MEMBER_MANAGER_ADDRESSTABLE_GET_API';
export const MEMBER_MANAGER_BANKTABLE_GET_API = 'MEMBER_MANAGER_BANKTABLE_GET_API';
export const MEMBER_MANAGER_INTRODUCERTABLE_GET_API = 'MEMBER_MANAGER_INTRODUCERTABLE_GET_API';
export const MEMBER_MANAGER_REBATETABLE_GET_API = 'MEMBER_MANAGER_REBATETABLE_GET_API';
export const MACHINE_MANAGER_MODELFORM_SUBMIT_API = 'MACHINE_MANAGER_MODELFORM_SUBMIT_API';
// DEPOSIT
export const DEPOSIT_MANAGER_TABLE_GET_API = 'DEPOSIT_MANAGER_TABLE_GET_API';
export const DEPOSIT_MANAGER_DETAIL_TABLE_GET_API = 'DEPOSIT_MANAGER_DETAIL_TABLE_GET_API';
export const DEPOSIT_MANAGER_FLOW_TABLE_GET_API = 'DEPOSIT_MANAGER_FLOW_TABLE_GET_API';
export const DEPOSIT_MANAGER_REFUNDFORM_SUBMIT_REQUESTTYPE = 'DEPOSIT_MANAGER_REFUNDFORM_SUBMIT_REQUESTTYPE';
export const JOBDEMAND_MANAGER_DEPOSITFLOW_TABLE_GET_API = 'JOBDEMAND_MANAGER_DEPOSITFLOW_TABLE_GET_API';
// TASKCLAIM_MANAGER
export const TASKCLAIM_MANAGER_TABLE_GET_API = 'TASKCLAIM_MANAGER_TABLE_GET_API';
export const TASKCLAIM_MANAGER_JOBREWARD_TABLE_GET_API = 'TASKCLAIM_MANAGER_JOBREWARD_TABLE_GET_API';
export const TASKCLAIM_MANAGER_JOBREWARD_TABLE_FROZEN_API = 'TASKCLAIM_MANAGER_JOBREWARD_TABLE_FROZEN_API';
export const TASKCLAIM_MANAGER_JOBREWARD_TABLE_UNFROZEN_API = 'TASKCLAIM_MANAGER_JOBREWARD_TABLE_UNFROZEN_API';
// JOBREWARD_MANAGER
export const JOBREWARD_MANAGER_TABLE_GET_API = 'JOBREWARD_MANAGER_TABLE_GET_API';
export const JOBREWARD_MANAGER_TABLE_FROZEN_API = 'JOBREWARD_MANAGER_TABLE_FROZEN_API';
export const JOBREWARD_MANAGER_TABLE_UNFROZEN_API = 'JOBREWARD_MANAGER_TABLE_UNFROZEN_API';
  ...
  return ajax(url, params).then(
    ...
    error => {
      if (error.errCode === '401') {
        ...
        return Promise.reject(error.errCode || '请求失败！')
      }
    }
  )
}
