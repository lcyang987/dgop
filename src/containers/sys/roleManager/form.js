...
import ThisForm from '@/components/sys/roleManager/form';

class ContainersRoleManagerForm extends Component {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersRoleManagerForm)