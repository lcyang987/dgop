...
import ThisForm from '@/components/machineManager/form';

class ContainersMachineManagerForm extends Component {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersMachineManagerForm)