...
import ThisForm from '@/components/audit/auditJobDemand/form';

class ContainersAuditJobDemandForm extends Component {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersAuditJobDemandForm)