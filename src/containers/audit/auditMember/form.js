...
import ThisForm from '@/components/audit/auditMember/form';

class ContainersAuditMemberForm extends Component {
  static propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ContainersAuditMemberForm)