...
class ComponentsBankConfigTable extends Component {
  static propTypes  = {
  ...
  render() {
    let columns = [{
      ...
      render: (text, record) => (
        <span>
          <a onClick={this.props.get.bind(this, record)}>编辑 一 {record.bankName}</a>
...
export default ComponentsBankConfigTable;