    ...
    return (
      ...
      >
        <Carousel ref="carousel">
          {
            this.props.data.map((t, i) => <div key={i}><a target="_blank" href={t} style={{ display: 'block', overflow: 'hidden', width: 500, height: 500, backgroundImage: `url(${t})`, backgroundSize: 'contain', backgroundPosition: 'center', backgroundRepeat: 'no-repeat' }}> </a></div>)
          }
        </Carousel>
        {
