...
const THISACTION = 'AUDIT_MEMBER_';
...
const tableGet = params => dispatch => dispatch({
  [APIS.AUDIT_MEMBER_TABLE_GET_API]: {
    types: Object.values(thunk.tableGet),
    url: 'mbr/memberAuthenticationList.json',
    params: params,
  }
});
